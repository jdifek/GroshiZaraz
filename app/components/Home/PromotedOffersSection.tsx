  ...
  const promotedOffers = [
    {
      ...
      description: "Подай заявку на любой займ через наш сервис и участвуй в розыгрыше главного приза",
    ...
    },
    {
      ...
      description: "Первый займ до 15 000 грн без процентов на срок до 30 дней от проверенных МФО",
    ...
    },
    {
      ...
      description: "Получайте кэшбэк за каждую покупку и зарабатывайте на остатке средств на карте",
    ...
    },
    {
      ...
      description: "Надежное размещение средств в топовых банках Украины с гарантированной доходностью",
            ...
            >
              <div className="bg-white rounded-3xl shadow-lg hover:shadow-xl transition-all duration-300 overflow-hidden border-2 border-transparent hover:border-blue-500 h-full">
                <div className="relative">
                  <div className={`${offer.color} h-32 flex items-center justify-center text-4xl text-white relative overflow-hidden`}>
                    {offer.image}
        ...
        <div className="mt-16 bg-gradient-to-br from-gray-800 to-gray-900 rounded-3xl p-8 md:p-12 text-white relative overflow-hidden">
          ...
          <div className="relative z-10 text-center">
            ...
            <p className="text-gray-300 mb-8 max-w-2xl mx-auto">
              Наши эксперты помогут подобрать идеальное финансовое решение под ваши потребности и возможности
            </p>
