  ...
  <div className="flex items-center justify-center w-full h-full">
    {companyInfo.logo}
              ...
              <div className="flex items-center gap-4 mb-6">
                <div
                  className={`md:block hidden w-20 h-20 bg-gradient-to-br ${companyInfo.color} rounded-2xl flex items-center justify-center text-white text-2xl shadow-lg`}
                >
                  {companyInfo.logo}
                </div>
                <div>
            ...
            <div>
              ...
              <div className="bg-gradient-to-r from-blue-50 to-blue-100 rounded-2xl p-6 border border-blue-200">
                ...
                <p className="text-gray-700 leading-relaxed">
                  ООО «Hurma Credit МКК» — российская микрофинансовая
                  организация, которая выдает срочные займы на карту по всей
                  России. Компания специализируется на предоставлении быстрых
                  микрозаймов с минимальными требованиями к заемщикам.
                  Особенностью является предоставление первого займа под 0% для
                  новых клиентов.
                </p>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="space-y-4">
                ...
                <div className="bg-gray-50 rounded-2xl p-6">
                  ...
                  <p className="text-gray-600">
                    Только паспорт гражданина РФ и банковская карта для
                    получения средств.
                  </p>
                </div>
                <div className="bg-gray-50 rounded-2xl p-6">
