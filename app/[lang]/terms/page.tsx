...
export async function generateMetadata({
  ...
  const title = isUa
    ...
    : "Условия использования сервиса — Фіногляд";
  ...
  const description = isUa
    ...
    : "Ознакомьтесь с условиями использования сервиса Фіногляд: правила, обязанности пользователей и ограничения ответственности.";
