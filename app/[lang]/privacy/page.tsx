        ...
        <div className="space-y-6">
          <section>
            ...
            <p className="text-gray-600 leading-relaxed mb-4">
              ...
              персональных данных пользователей агрегатора финансовых услуг
              Фіногляд (далее - &ldquo;Сервис&ldquo;). Мы уважаем право на
              конфиденциальность и стремимся защитить персональные данные наших
              пользователей.
            </p>
          ...
          <section>
            ...
            <div className="bg-gray-50 rounded-xl p-6">
              ...
              <ul className="space-y-2 text-gray-600">
                ...
                <li>
                  • Финансовая информация (доходы, расходы, кредитная история)
                </li>
          ...
          <section>
            ...
            <div className="bg-yellow-50 rounded-xl p-6">
              ...
              <p className="text-gray-600 mt-4 text-sm">
                Все наши партнеры обязуются соблюдать конфиденциальность ваших
                данных.
              </p>
            </div>
          </section>
          ...
          <section>
            ...
            <div className="bg-blue-50 rounded-xl p-6">
              ...
              <div className="space-y-2 text-gray-600">
                <p>
                  <strong>Email:</strong> privacy@Фіногляд.ua
                </p>
                <p>
