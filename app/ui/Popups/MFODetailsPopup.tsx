      ...
      <div className="bg-white scrollbar-hidden overflow-y-auto rounded-2xl max-w-lg w-full max-h-[90vh] flex flex-col shadow-2xl">
        ...
        <div className="px-6 pb-6">
            ...
            <div className="space-y-4">
              <div className="space-y-3">
                ...
                <div className="flex justify-between items-center py-2 border-b border-gray-100">
                  ...
                  <span className="font-semibold text-gray-800">{mfo.minTerm} - {mfo.maxTerm} дней</span>
                </div>
                <div className="flex justify-between items-center py-2 border-b border-gray-100">
                ...
                <div className="flex justify-between items-center py-2 border-b border-gray-100">
                  ...
                  <span className="font-semibold text-gray-800">to be soon</span>
                </div>
                <div className="flex justify-between items-center py-2">
                  <span className="text-gray-600">Залог</span>
                  <span className="font-semibold text-gray-800">to be soon Без залога</span>
                </div>
              </div>
              ...
              {mfo && (
                <div className="bg-gradient-to-r from-green-50 to-green-100 border border-green-200 rounded-lg p-3 mt-4">
                  ...
                  <p className="text-green-700 text-xs">Новые клиенты получают займ под 0%</p>
                </div>
              )}
            </div>
          )}
            ...
            <div className="space-y-4">
              <div className="space-y-3">
                <div className="flex justify-between items-center py-2 border-b border-gray-100">
                  ...
                  <span className="font-semibold text-green-600">to be soon</span>
                </div>
                <div className="flex justify-between items-center py-2 border-b border-gray-100">
                ...
                <div className="flex justify-between items-center py-2 border-b border-gray-100">
                  ...
                  <span className="font-semibold text-blue-600">to be soon</span>
                </div>
              </div>
              ...
              <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-3">
                ...
                <p className="text-yellow-700 text-xs">
                  Займы выдаются лицам старше 18 лет. Помните о необходимости своевременного погашения. Просрочка может негативно повлиять на вашу кредитную историю.
                </p>
              </div>
            </div>
          )}
            ...
            <div className="space-y-4">
              <div className="space-y-3">
                <div className="flex justify-between items-center py-2 border-b border-gray-100">
                  ...
                  <span className="font-semibold text-gray-800">{mfo?.ageFrom} - {mfo?.ageTo} лет</span>
                </div>
                <div className="flex justify-between items-center py-2 border-b border-gray-100">
                ...
                <div className="flex justify-between items-center py-2 border-b border-gray-100">
                  ...
                  <span className="font-semibold text-gray-800">{mfo.documents}</span>
                </div>
              </div>

              <div className="bg-green-50 border border-green-200 rounded-lg p-3">
                <h4 className="font-semibold text-green-800 mb-2 text-sm">Преимущества</h4>
                <div className="space-y-1">to be soon</div>
              </div>
            </div>
          )}
          ...
          <div className="flex items-center mt-6 justify-between">
            <BlueButton text="Получить деньги" link={mfo.UtmLink} />
